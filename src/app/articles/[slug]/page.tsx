  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', paddingInline: 'clamp(20px, 4vw, 64px)' }}>
        <div style={{ marginBottom: 24, fontSize: 13, color: 'var(--ink-3)' }}>
          <Link href="/" style={{ color: 'inherit' }}>בית</Link> · <Link href="/articles" style={{ color: 'inherit' }}>מאמרים</Link> · {article.title}
        </div>
